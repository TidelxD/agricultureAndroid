...
// Retrofit Start = { Retrofit Biblio dir Connection bin App w DATABASE Using  URL OF L HOST [ CONSTANS.NODEJS_ROOT_URL]
        ...
        call.enqueue(new Callback<List<Actutors>>() {
            ...
            public void onResponse(@NonNull Call<List<Actutors>> call, @NonNull Response<List<Actutors>> response) {
                ...
                // state 0 = { means that the engine1 if OFF  and 1 means that its ON
                ...
                // state 0 = { means that the engine2 if OFF  and 1 means that its ON
    ...
    private void updateActutor(Actutors helper, int state) {
        ...
        call.enqueue(new Callback<Actutors>() {
            ...
            public void onResponse(Call<Actutors> call, Response<Actutors> response) {
                ...
                // when the compiler reach this place means that the update done successfully
                progressDialog.dismiss();
